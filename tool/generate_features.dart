...
final Map<String, Map<String, dynamic>> resourceConfig = {
  ...
  'cleansing-touch': {
    'currentUses': 0, 'maxUses': 0, 'recoveryType': 'longRest', 'calculationFormula': 'cha_mod',
    'forcedType': 'action'
  },
  ...
  'wild-shape': {
    'currentUses': 2, 'maxUses': 2, 'recoveryType': 'shortRest',
    'forcedType': 'action' // Bonus for Moon Druid handled in subclass override if needed
  },
  ...
  'metamagic-1': { 'forcedType': 'passive' }, // Selection
  'metamagic-2': { 'forcedType': 'passive' },
  'metamagic-3': { 'forcedType': 'passive' },
  'metamagic-4': { 'forcedType': 'passive' },
