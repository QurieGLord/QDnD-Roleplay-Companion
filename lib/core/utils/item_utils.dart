...
class ItemUtils {
  ...
  static String getLocalizedTag(AppLocalizations l10n, String tag) {
    switch (tag.trim().toLowerCase()) {
      case 'ammunition':
        return l10n.propertyAmmunition;
      case 'finesse':
        return l10n.propertyFinesse;
      case 'heavy':
        return l10n.propertyHeavy;
      case 'light':
        return l10n.propertyLight;
      case 'loading':
        return l10n.propertyLoading;
      case 'range':
        return l10n.propertyRange;
      case 'reach':
        return l10n.propertyReach;
      case 'special':
        return l10n.propertySpecial;
      case 'thrown':
        return l10n.propertyThrown;
      case 'two-handed':
      case 'two_handed':
        return l10n.propertyTwoHanded;
      case 'versatile':
        return l10n.propertyVersatile;
      case 'martial':
        return l10n.propertyMartial;
      case 'simple':
        return l10n.propertySimple;
      default:
        return tag;
    }
  }

  static String getLocalizedDamageType(
      AppLocalizations l10n, String damageType) {
  ...
  static String getLocalizedArmorType(AppLocalizations l10n, String armorType) {
    ...
    switch (lower) {
      case 'light':
        return l10n.armorTypeLight;
      case 'medium':
        return l10n.armorTypeMedium;
      case 'heavy':
        return l10n.armorTypeHeavy;
      case 'shield':
        return l10n.armorTypeShield;
      default:
        return armorType;
    }
  }
  ...
  static String getLocalizedTypeName(AppLocalizations l10n, ItemType type) {
    switch (type) {
      ...
      case ItemType.gear:
        return l10n.typeGear;
      case ItemType.consumable:
        return l10n.typeConsumable;
      case ItemType.tool:
        return l10n.typeTool;
      case ItemType.treasure:
        return l10n.typeTreasure;
    }
  }

  static String getLocalizedRarityName(
      AppLocalizations l10n, ItemRarity rarity) {
    switch (rarity) {
